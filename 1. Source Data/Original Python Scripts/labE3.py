...
name =
plt.plot(Ap,cNap,'o')
plt.legend(['cNa0 freq Amplitude plot'])
plt.show() 
plt.safefig('2 '+name) 
...
plt.legend(['callibration Na0 Voigt fit freq(A) plot'])
plt.show()
plt.safefig('3 '+name)
...
name =         
plt.plot(Ap,cMnp,'o')
plt.legend(['callibration Mn0 freq v Amplitude plot'])
plt.show()        
plt.safefig('4 '+name)
...
plt.legend(['callibration Mn0 Voigt fit Intensity vs. freq(A) plot'])
plt.show()
plt.safefig('5 '+name)
...
name = 
plt.plot(Ap,cCsp,'o')
plt.legend(['callibration Cs0 Data-Counts v freq(A) plot'])
plt.show()
plt.safefig('6 '+name)    
...
plt.legend(['callibration Cs0 Voigt fit Intensity vs. freq(A) plot'])
plt.show()
plt.safefig('7 '+name)
...
name =         
plt.plot(Ap,cAmp,'o')
plt.legend(['callibration Am0 Data-Counts v freq(A) plot'])
plt.show()  
plt.safefig('8 '+name)     
...
plt.legend(['callibration Am0 Voigt fit Intensity vs. freq(A) plot'])
plt.show()
plt.safefig('9 '+name)
...
plt.legend(['Peak Amplitude Frequencies Vs Known Element Peak Energies \n (with Errors)'])
plt.show()
plt.safefig('9 '+name)
...
name = 
plt.plot(T,p(T))
plt.legend(['Best-fit Amplitude vs Energy Correlation'])
plt.show()
plt.safefig('10 '+name)
...
name = 
plt.legend(['Energy vs FreqCount 20deg Cs plot - untrimmed x-values'])
plt.show()
plt.safefig('11 '+name)
...
plt.legend(['Energy vs FreqCount 20deg Cs plot - bins of 8'])
plt.show() 
plt.safefig('13 '+name)       
...
plt.legend(['Gauss-Fit - Energy vs FreqCount 20deg Cs plot','20','30','45'])
plt.show()
plt.safefig('14 '+name)
...
plt.legend(['Energy vs FreqCount 30deg Cs plot - bins of 8'])
plt.show()      
plt.safefig('15 '+name)
...
plt.plot(A2,sCsp2,'o')
plt.legend(['Gauss-Fit - Energy vs FreqCount 30deg Cs plot','20','30','45'])
plt.show()
...
plt.legend(['Energy vs FreqCount 45deg Cs plot - bins of 8'])
plt.show()       
...
plt.legend(['Gauss-Fit - Energy vs FreqCount 45deg Cs plot','20','30','45'])
plt.show()
...
plt.legend(['1/Peak-Energy vs Cos-theta Cs plot \n with Errors'])
plt.show()
...
plt.plot(T,p(T))
print(fit)
plt.legend(['Best-fit line for 1/Peak-Energy vs Cos-theta Cs plot'])
plt.show()
