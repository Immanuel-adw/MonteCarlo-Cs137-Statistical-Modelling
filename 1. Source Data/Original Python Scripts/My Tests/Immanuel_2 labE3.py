...
plt.plot(A3,sCsp3,'o')
plt.legend(['Energy vs FreqCount 45deg Cs plot - bins of 8', 'Gaussian Dist. Fit'])
plt.show()
plt.savefig('10 '+name)
...
name = 'Inverse of Peak-Energy vs Cos-theta Cs plot'
...
name = 'Best-fit line for Inverse(Peak-Energy) vs Cos-theta Cs plot'
plt.plot(T,p(T))
print(fit)
